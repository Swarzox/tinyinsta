...
function App() {
	...
	return (
		e("div", { className: "w-screen" },
			...
			hasSession && feed && e(Feed,{setCurrentProfil, pageFeed: setFeed},null),
			hasSession && (currentProfil != "") && e(Profil, {currentProfil, userId: user.id, setUpload, handleSignOut, setCurrentProfil}, null),
			hasSession && upload && e(Upload, {setUpload, userId: user.id, setCurrentProfil}, null),
